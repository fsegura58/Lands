namespace Lands.API.Helpers
{
    ...
    public class UsersHelper : IDisposable
    {
        ...
        public static async Task PasswordRecovery(string email)
        {
            ...
            {
                var subject = "Lands App - RecuperaciÃ³n de contraseÃ±a";
                var body = string.Format(@"
                    <h1>Lands App - RecuperaciÃ³n de contraseÃ±a</h1>
                    <p>Su nueva contraseÃ±a es: <strong>{0}</strong></p>
                    <p>Por favor no olvide cambiarla por una de fÃ¡cil recordaciÃ³n",
                    newPassword);
